<xsl:stylesheet xmlns:xsl = "http://www.w3.org/1999/XSL/Transform" version = "1.0" >
  ...
  <xsl:template match = "/icestats">
    <html>
    <head>
    <title>Beheer - C.S.R. Radio Streaming Media Server</title>
    ...
    <div class="container"> 
      ...
      <div class="header">
        <ul class="nav nav-pills pull-right">
          <li class="active"><a href="admin/">Beheer</a></li>
          <li><a href="status.xsl">Server Status</a></li>
          <li><a href="server_version.xsl">Versie</a></li>
        </ul>
        <h3 class="text-muted">C.S.R. Radio Streaming Media Server</h3>
      </div>
